...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        let embed = new Discord.MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true })).setColor('#5865F2').setTimestamp()
        let channel = client.guilds.cache.get(client.config.guildID).channels.cache.get(client.config.banLog)

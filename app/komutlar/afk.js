...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        message.channel.send(embed.setDescription("Başarılı Bir Şekilde AFK Moduna Girdin. Herhangi bir kanala birşey yazana kadar afk sayılıcaksın!")).then(x => x.delete({ timeout: 10000 }))
